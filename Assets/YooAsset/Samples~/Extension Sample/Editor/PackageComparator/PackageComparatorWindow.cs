...
namespace YooAsset.Editor
{
    public class PackageComparatorWindow : EditorWindow
    {
        ...
        private void ComparePackage(List<PackageBundle> changeList, List<PackageBundle> newList)
        {
            ...
            PackageManifest manifest1 = PackageManifestTools.DeserializeManifestFromBinary(bytesData1, null); //TODO 自行处理解密

            // 加载补丁清单1
            byte[] bytesData2 = FileUtility.ReadAllBytes(_manifestPath2);
            PackageManifest manifest2 = PackageManifestTools.DeserializeManifestFromBinary(bytesData2, null); //TODO 自行处理解密
