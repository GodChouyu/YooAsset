...
namespace YooAsset
{
    internal class ClearCacheBundleFilesByLocationsOperaiton : FSClearCacheOperation
    {
        private enum ESteps
        {
            None,
        ...
        internal ClearCacheBundleFilesByLocationsOperaiton(CacheFileSystem fileSystem, PackageManifest manifest, object clearParam)
        {
