...
namespace YooAsset
{
    internal class ClearCacheBundleFilesByTagsOperaiton : FSClearCacheOperation
    {
        private enum ESteps
        {
            None,
        ...
        internal ClearCacheBundleFilesByTagsOperaiton(CacheFileSystem fileSystem, PackageManifest manifest, object clearParam)
        {
